...
def calc_mean_std(feat, eps=1e-5):
    ...
    feat_variance = feat.view(batch_size,channels,-1).var(dim=2,unbiased=False) + eps
    feat_std = feat_variance.sqrt().view(batch_size,channels,1,-1)
